                ...
                <div class="modal-content" :class="submitError" style="background-color: whitesmoke">
                    ...
                    <form action="#" @submit.prevent="submit">
                        ...
                        <div class="modal-footer">
                            ...
                            <input type="submit" class="btn btn-primary" :disabled="btnDisabled" :class="btnError" value="Editar">
                        </div>
                    </form>
                </div>
            </div>
...
export default {
    ...
    data() {
        return {
            ...
            btnError: "",
            submitError: "",
            actionLink: "/grades/" + this.c_id + "/update/" + this.ev_id
        };
    },

    methods: {
        resetInputs() {
            this.gradeInput = this.ev_grade;
            this.submitError = "";
